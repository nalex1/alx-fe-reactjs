...
function UserProfile() {
  return (
    <div className="user-profile bg-gray-100 sm:p-4 md:p-8 md:max-w-sm sm:max-w-xs mx-auto my-20 rounded-lg shadow-lg ">
      <img src={profileImg} alt="User" className="rounded-full mx-auto sm:w-24 sm:h-24 md:w-36 md:h-36" />
      <h1 className="md:text-xl text-blue-800 my-4 sm:text-lg md:text-base">John Doe</h1>
